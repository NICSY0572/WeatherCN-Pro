...
const WeatherCN = (() => {
  ...
  async function handleResponse() {
    ...
    const originalBody = responseBodyText(response);
  ...
  function isAvailabilityRequest(request) {
    return /weatherkit\.apple\.com\/api\/v1\/availability\//.test(String(request && request.url || ""));
  }
  ...
  function responseBodyText(response) {
    ...
    return bytesToText(response.bodyBytes || response.body);
  }
